...
uint8_t counts[10] = {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39};
uint16_t counts_index = -1;
...
void updateCounter() {
  ...
  uint8_t buf[1] = {counts[counts_index % 10]};
  ble.updateCharacteristicValue(characteristic2.getValueAttribute().getHandle(), buf, 1);
}
...
void setup() {
    ...
    ble.accumulateAdvertisingPayload(GapAdvertisingData::SHORTENED_LOCAL_NAME,
                                     (const uint8_t *)"Counter", sizeof("Counter") - 1);
